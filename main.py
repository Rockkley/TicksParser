...
class TicksGetter:
    ...
    def get_account_from_string(self, account_info: str) -> LoginInfo | bool:
        """

        :param account_info: name of saved account.
        :return: LoginInfo file that contains data for authorisation.
        """
        try:
            # Getting LoginInfo object by 'settings' argument
            return getattr(Accounts, account_info.lower())
    ...
    def save_to_file(self, format_: Formats) -> bool:
        ...
        for ticks_file in self.collected_tickets:
            ...
            # Call a save function corresponding to given format
            try:
